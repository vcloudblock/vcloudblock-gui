...
class Blocks extends React.Component {
    ...
    handleScratchExtensionAdded (extensionInfo) {
        ...
        categoryInfoArray.forEach(categoryInfo => {
            ...
            // vcloudblock-blocks implements a menu or custom field as a special kind of block ("shadow" block)
     ...
     * to the variable validation prompt callback used in vcloudblock-blocks.
     */
